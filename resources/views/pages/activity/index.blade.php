            ...
            <section class="section">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endphp
                        <div class="row">
                            <form method="GET" action="{{ route('activity.index') }}" id="pagination-form"
                            ...
                            <form method="POST" action="{{ route('activity.filter') }}" id="search-form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="q"
                                                ...
                                                placeholder="Ketik Nama Aktivitas & Klik Enter ..."
                                    ...
                                    <div class="col-lg-1 col-3">
                                        <a href="{{ route('activity.reset') }}" class="btn btn-secondary" type="button"
                                        ...
                                        @foreach ($results as $act)
                                            ...
                                            <tr data-tooltip="{{ $tooltip }}">
                                                ...
                                                <td class="text-center">
                                                    @if (session('user.role') == 'SUPERADMIN' || $author_status)
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            <button
                                                                class="dropdown-item {{ $act['status'] == 'DONE' ? 'active' : '' }}"
                                                                onclick="changeStatus({{ $act['id'] }}, 'DONE')">DONE</button>
                                                            <button
                                                                class="dropdown-item {{ $act['status'] == 'ON PROGRESS' ? 'active' : '' }}"
                                                                onclick="changeStatus({{ $act['id'] }}, 'ON PROGRESS')">ON
                                                                PROGRESS</button>
                                                        </div>
                                                    @else
                                                ...
                                                <i class="fa-solid fa-pen"></i>
                                                    ...
                                                    <a href="{{ route('activity.doc', $act['id']) }}"
