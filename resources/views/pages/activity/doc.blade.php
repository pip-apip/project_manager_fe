                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-10">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ $activity['project_name'] }}" readonly />
                                </div>
                                <div class="col-md-2">
                                    <label>Tanggal</label>
                                </div>
                                <div class="form-group col-md-10">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ \Carbon\Carbon::parse($activity['start_date'])->translatedFormat('d-m-Y') }}"
                                        readonly />
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="form-group col-md-10">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ $activity['activity_category_name'] }}" readonly />
                                </div>
                                <div class="col-md-2">
                    ...
                    <div class="col-sm-12" id="tagsSearch">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                @if ($data['docActivity'])
                                    <div>
                                        <button class="btn btn-warning btn-sm me-2" id="actionButton" onclick="editDoc()"><i
                                                class="fa-solid fa-pen"></i></button>
                                        <button class="btn btn-danger btn-sm" id="btnDelete"
                                            onclick="confirmDelete('{{ route('activity.doc.delete', ':id') }}')"><i
                            ...
                            <div class="card-body" id="form_MOM" style="display: none">
                                <form action="" id="form" class="form form-vertical">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-10">
                                            <input type="text" placeholder="Masukkan Judul Dokumen Kegiatan"
                                                class="form-control" name="title" id="title_activity_doc"
                                                autocomplete="off" />
                                        </div>
                                        ...
                                        <div class="form-group col-md-10">
                                            <input type="date" class="form-control" name="date" id="date_activity_doc"
                                                autocomplete="off" />
                                        </div>
                                        ...
                                        <div class="form-group col-md-10">
                                            <input type="text" placeholder="Masukkan Lokasi Kegiatan"
                                                class="form-control" name="location" id="location_activity_doc"
                                                autocomplete="off" />
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <label>Meet of Person <code>*</code></label>
                                        </div>
                                        <div id="meet_of_person_list" class="col-md-9 col-span-2 ">

                                        </div>

                                        <div class="col-md-2">
                                            <label>Agenda <code>*</code></label>
                                        </div>
                                        <div id="agenda_list" class="col-md-9 col-span-2 ">

                                        </div>

                                        <div class="col-md-2">
                                            <label>Aktifitas <code>*</code></label>
                                        </div>

                                        <div id="activity_list" class="col-md-9 col-span-2 ">
                                        ...
                                        <div class="form-group col-md-10">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="tagInput"
                                                    placeholder="Ketik dan Tekan Enter..." name="tags" />
                                            </div>
                                        ...
                                        <div class="col-md-10" id="dropzone-container" style="display: none">
                                            <div class="file-upload-wrapper" id="dropzone">
                                                <label for="file-upload"
                                                    class="file-upload-area @error('file') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-12 offset-sm-2 d-flex justify-content-start mt-3">
                                            <button type="button" class="btn btn-primary me-1 mb-1" id="submitButton"
                                                onclick="storeDoc()">Simpan</button>
                                            <button type="reset"
                            ...
                            <div class="card-body" id="show_MOM" style="display: none">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-static" id="date_show"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <label><b>Tanggal : </b></label>
                                        <div class="form-group">
                                            <div class="form-control-static" id="location_show"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <label><b>Peserta Aktivitas : </b></label>
                                        <div id="meet_of_person_show">

                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <label><b>Agenda Aktivitas : </b></label>
                                        <div id="agenda_show">

                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <label><b>Aktivitas : </b></label>
                                        <div id="activity_list_show">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="table">
                                                ...
                                                <tbody id="table-body">
                                                    @php
                                                        $i = 1;
                                                        $url = env('API_BASE_URL_MAIN') . '//storage/';
                                                    @endphp
                                                    @if ($data['docActivity'])
                                                        @foreach ($data['docActivity'][0]['files'] as $doc)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    {{ pathinfo($doc['url'], PATHINFO_EXTENSION) }}</td>
                                                                <td class="text-center">
                                                                    {{ $doc['size'] }}
                                                                </td>
                                                                <td class="text-center">
                                                                    ...
                                                                    @else
                                                                        <a onclick="openModernModal('{{ $url . $doc['url'] }}')"
                                                                            style="text-decoration: none; color: grey; font-size: 20px; cursor: pointer">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            inputSections.forEach(section => {
                initializeInputSection(section);
                // populateInputSection(section.id, section.className, section.label);
            });

            // Optional: Prevent default form submission when Enter is pressed
        ...
        function initializeInputSection({
            ...
            // Render default input if container is empty
            function renderInitial() {
                if (container.children('.d-flex').length === 0) {
                    container.html(generateInputHTML(1, className, label));
                }
            }

            // Add new input
            function addInput() {
                const inputCount = container.children('.d-flex').length + 1;
                container.append(generateInputHTML(inputCount, className, label));
                container.find('.' + className).last().focus();
            }

            // Remove input
            container.on('click', '.btn-remove', function() {
                const totalInputs = container.children('.d-flex').length;
                if (totalInputs > 1) {
                    $(this).closest('.d-flex').remove();
                    updateNumbering();
                } else {
                    $(this).closest('.d-flex').find('input').val('');
                }
            });


            // Handle Enter key
            container.on('keyup', '.' + className, function(e) {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    addInput();
                }
            ...
            // Update numbering and placeholders
            function updateNumbering() {
                container.children('.d-flex').each(function(index) {
                    const number = index + 1;
                    $(this).find('p').text(`${number}. `);
                    $(this).find('input').attr('placeholder', `Masukkan ${label} ${number}`);
                });
            }

            // Input block HTML
            function generateInputHTML(number, inputClass, inputLabel) {
                return `
                <div class="d-flex align-items-center mb-3 gap-2">
                    <p class="mb-0 me-2">${number}. </p>
                    <input type="text" class="form-control ${inputClass}" placeholder="Masukkan ${inputLabel} ${number}" />
...
@endif --}}
    ...
    <script>
        ...
        function showDoc(data) {
            ...
            let id = data[0]['id'];
            let meet_of_person = data[0]['meet_of_person'] || [];
            let agendas = data[0]['agenda'] || [];
            let activity_list = data[0]['activity'] || [];
            let date = data[0]['date'];
            let location = data[0]['location'];

            $('#date_show').text(date ? new Date(date).toLocaleDateString('id-ID') : 'Tidak ada tanggal');
            $('#location_show   ').text(location || 'Tidak ada lokasi');
            ...
            $('#meet_of_person_show').empty();
            let personElement = `<ol>`;
            if (meet_of_person.length === 0) {
                personElement += `<li>Tidak ada peserta</li>`;
            } else {
                meet_of_person.forEach((person) => {
                    personElement += `<li>${person}</li>`;
                });
            }
            personElement += `</ol>`;
            $('#meet_of_person_show').append(personElement);

            $('#agenda_show').empty();
            let agendaElement = '';
            if(agendas.length === 1){
                agendaElement = `<p>${agendas[0]}</p>`;
            }else{
                agendaElement = `<ol>`;
                if (agendas.length === 0) {
                    agendaElement += `<li>Tidak ada agenda</li>`;
                } else {
                    agendas.forEach((agenda) => {
                        agendaElement += `<li>${agenda}</li>`;
                    });
                }
                agendaElement += `</ol>`;
            }
            $('#agenda_show').append(agendaElement);

            $('#activity_list_show').empty();
            let activityElement = `<ol>`;
            if (activity_list.length === 0) {
                activityElement += `<li>Tidak ada aktivitas</li>`;
            } else {
                activity_list.forEach((act) => {
                    activityElement += `<li>${act}</li>`;
                });
            }
            activityElement += `</ol>`;
            $('#activity_list_show').append(activityElement);
        ...
        function editDoc() {
            $('#actionButton').attr('onclick', 'cancelEdit()').attr('class', 'btn btn-secondary btn-sm').html(
            ...
            // $('#date_activity_doc').val(docData.date ? new Date(docData.date).toISOString().split('T')[0] : '');
            $('#location_activity_doc').val(docData.location);
            $('#category_id').val(docData.activity_doc_category_id);

            populateInputSection('meet_of_person_list', 'person-input', 'Person', docData.meet_of_person);
            populateInputSection('agenda_list', 'agenda-input', 'Agenda', docData.agenda);
            populateInputSection('activity_list', 'activity-input', 'Aktivitas', docData.activity);
        ...
        function populateInputSection(id, className, label, values = []) {
            console.log(`Populating section: ${id} with values:`, values);
            const container = $('#' + id);
            container.empty();
            ...
            values.forEach((value, index) => {
                container.append(`
                <div class="d-flex align-items-center mb-3 gap-2">
                    <p class="mb-0 me-2">${index + 1}. </p>
                    <input type="text" class="form-control ${className}" value="${value}" placeholder="Masukkan ${label} ${index + 1}" />
                    <button type="button" class="btn btn-danger btn-sm btn-remove">
                        <i class="fa-solid fa-trash"></i>
                    </button>
                </div>
            ...
            if (values.length === 0) {
                ...
                <div class="d-flex align-items-center mb-3 gap-2">
                    ...
                    <input type="text" class="form-control ${className}" placeholder="Masukkan ${label} 1" />
                    <button type="button" class="btn btn-danger btn-sm btn-remove">
                        <i class="fa-solid fa-trash"></i>
                    </button>
                </div>
        ...
        function cancelEdit() {
            $('#actionButton').attr('onclick', 'editDoc()').attr('class', 'btn btn-warning btn-sm').html(
        ...
        function updateDoc() {
            ...
            formData.append('person', JSON.stringify(personArray));

            let agendaArray = [];
            $('.agenda-input').each(function() {
                const value = $(this).val().trim();
                if (value) {
                    agendaArray.push(value);
                }
            });
            ...
            formData.append('activity', JSON.stringify(activityArray));
                            ...
                            Object.keys(errors).forEach(function(key) {
                                if (key.startsWith('files.')) {
                                    ...
                                    if (fileItems[index]) {
                                        ...
                                        fileItems[index].insertAdjacentElement('afterend',
                                            errorEl);
                                    }
                                } else {
                                    // Other form errors
