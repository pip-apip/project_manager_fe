        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @if (session('user.role') === 'SUPERADMIN' || session('user.role') === 'ADMIN' || session('user.project_leader'))
                    <li
                        class="sidebar-item {{ $title == 'categoryAct' || $title == 'categoryAdm' ? 'active' : '' }} has-sub">
                ...
                @endif
                @if (session('user.role') === 'SUPERADMIN' || session('user.role') === 'ADMIN')
                    <li class="sidebar-item {{ $title == 'ca' || $title == 'caProject' ? 'active' : '' }} has-sub"
                        style="display: none">
                        <a href="#" class='sidebar-link'>
