...
<script>
    ...
    function fillForm(id) {
        ...
        $('#project_id').val(activity.project.id);
...
<script>
    ...
    async function getActivityId_n_catId(id_activity, category_id) {
        console.log("Fetching document for activity ID:", id_activity, "and category ID:", category_id);
        try {
    ...
    async function editDoc(id) {
        ...
        try {
            ...
            console.error("Error in editDoc:", error);
        }
    }
