...
class UploaderController extends Controller
{
    ...
    */
    protected function saveFile(UploadedFile $file, Request $request) {
        ...
        $folder  = $folderDATE;
        $filePath = "public/upload/medialibrary/777/{$folder}/";
        ...
        $url_base = 'storage/upload/medialibrary/777'."/{$folderDATE}/".$fileName;
    ...
    */
    public function delete (Request $request){
        ...
        $filePath = "public/upload/medialibrary/777/{$dir}/";
        $finalPath = storage_path("app/".$filePath);
    ...
    public function uploadChunk(Request $request)
    {
        ...
        if ($save->isFinished()) {
            ...
            $path = $file->storeAs('admin_docs', $fileName, 'public');
    ...
    public function deleteChunk(Request $request)
    {
        ...
        if (!str_starts_with($filePath, 'admin_docs/')) {
